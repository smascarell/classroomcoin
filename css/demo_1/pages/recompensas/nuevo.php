          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Añadir nueva recompensa</h4>
                    <form class="form-sample" method="POST" action="nueva_recompensa.php">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Recompensa</label>
                            <div class="col-sm-8">
