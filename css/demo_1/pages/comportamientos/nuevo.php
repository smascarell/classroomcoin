          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Añadir nuevo comportamiento</h4>
                    <form class="form-sample" method="POST" action="nuevo_comportamiento.php">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Comportamiento</label>
                            <div class="col-sm-8">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                            <input type="submit" name="insertarNuevo" class="btn btn-success mr-2" value="Guardar"></button>
                            <input type="button" class="btn mr-2" name="cancelar" value="cancelar" onclick="javascript:history.go(-1)">
                          </div>
                      </div>
