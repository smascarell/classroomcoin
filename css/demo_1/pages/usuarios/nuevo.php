              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="nuevo_usuario.php">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <button name="nuevo_usuario" type="submit" class="btn btn-success mr-2">Guardar</button>
                          <input type="button" name="cancelar" value="Cancelar" class="btn btn-light" onClick="javascript:history.go(-1)"></input>
                        </div>
                      </div>
                    </div>
                    </div>
