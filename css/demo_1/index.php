          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-usuarios">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/usuarios/admin.php">Admin</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/usuarios/alumnos.php">Alumnos</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/usuarios/profesores.php">Profesores</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-recompensas">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/buttons.html">Gemas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/dropdowns.html">Monedas</a>
                  </li>
                  </li>
                </ul>
              </div>
