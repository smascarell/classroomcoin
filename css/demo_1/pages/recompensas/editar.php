<?php
  ...
  $result = $db->Query($sql);
  $recompensa = mysqli_fetch_assoc($result);
?>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h1>"<?php echo $recompensa['nombre']; ?> "</h1>
                    <form class="form-sample" method="POST" action="actualizar.php">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Recompensa</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nombre" value="<?php echo $recompensa['nombre'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="valor" value="<?php echo $recompensa['valor'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
