<?php
  ...
  $conn = $db->GetConn();
  $id = $_GET['id'];
  $sql = "SELECT * from comportamientos WHERE id= $id";
  $result = $db->Query($sql);
  $comportamiento = mysqli_fetch_assoc($result);
?>
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php include('/Applications/XAMPP/xamppfiles/htdocs/classroomcoin/css/demo_1/partials/_sidebar.php'); ?>
        <!-- partial -->
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample" method="POST" action="actualizar.php">
                      <h1>"<?php echo $comportamiento['nombre']; ?> "</h1>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Cambiar a </label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="nombre" value="<?php echo $comportamiento['nombre'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nuevo valor</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="valor" value="<?php echo $comportamiento['valor'] ?>" />
                            </div>
                          </div>
                        </div>
                      </div>
